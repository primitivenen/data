...
#endday=`date --date="1 day ago" +%Y-%m-%d`
#startday=`date --date="today" +%Y-%m-%d`
#ddir=`date --date="today" +%Y%m%d`

d=startday
#returncode=`hdfs dfs -test -d hdfs://namenode:8020/data/guobiao/csv/d=$d`
#hdfs dfs -test -d hdfs://namenode:8020/data/guobiao/csv/d=$ddir
#echo hdfs://namenode:8020/data/guobiao/csv/d=$ddir
#returncode=$?
#echo $returncode
